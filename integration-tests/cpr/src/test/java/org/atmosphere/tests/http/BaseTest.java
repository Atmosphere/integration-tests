...
public abstract class BaseTest {
            ...
            public void onRequest(AtmosphereResource event) throws IOException {
                if (!b.getAndSet(true)) {
                    ...
                    event.getBroadcaster().getBroadcasterConfig().addFilter(new BroadcastFilter() {
                        ...
                        public BroadcastAction filter(String id, Object o, Object message) {
    ...
    public void testBroadcastFactoryNewBroadcasterTimeout() {
        ...
        atmoServlet.framework().addAtmosphereHandler(ROOT, new AbstractHttpAtmosphereHandler() {
            ...
            public void onRequest(AtmosphereResource event) throws IOException {
                ...
                event.suspend(5000);
                try {
                    Broadcaster b = factory().lookup(DefaultBroadcaster.class, "ExternalBroadcaster", true);
    ...
    public void testConcurrentBroadcast() {
        ...
        try {
            ...
            factory().lookup(DefaultBroadcaster.class, "suspend").destroy();
            c.close();
        }
    }
